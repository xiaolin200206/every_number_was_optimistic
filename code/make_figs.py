...
# ---------------- Fig. 1 ----------------
kfA, _ = fit(GFLOPS, la)
fig, (a1, a2) = plt.subplots(1, 2, figsize=(9.475, 3.495), dpi=300)
...
fig, axes = plt.subplots(1, 2, figsize=(9.645, 3.645), dpi=300)
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(9.76, 3.34), dpi=300)
